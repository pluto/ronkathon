...
Here, a₀ represents the secret, and the subsequent coefficients $( a_1, a_2, \cdots, a_{k-1})$ are randomly chosen from a finite field. Each share is generated by evaluating the polynomial at a unique nonzero value of x (for example, x = 1, 2, …, n).  
